    ...
    <main >
      <div className="bg-slate-100 m-5 p-5">
        ...
        <table className="table-auto border-separate border-spacing-2"><tbody>
          ...
          <tr><td>Member Since</td>{createdAt.toString()}<td></td></tr>
          {/* <tr><td></td><td></td></tr> */}
        </tbody></table>

        {
          ...
          <form action={addCar}>
            ...
            <div className="flex items-center w-1/2 my-2">
              ...
              <label className="w-auto block text-gray-700 pr-4 ml-5" htmlFor="smallbags">Amall Bags</label>
            ...
            <button type="submit" className="rounded bg-blue-500 hover:bg-blue-700 text-white p-2">
              Add New Car
            </button>
